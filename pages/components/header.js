...
const Header = () => {
    ...
    const RenderThemeChanger = () => {
        ...
        if (currentTheme === 'dark') {
            return (
                <div className='flex flex-row justify-center items-center w-10 h-10 fill-yellow-500' onClick={() => setTheme('light')}>
            ...
            return (
                <div className='flex flex-row justify-center items-center w-10 h-10 fill-slate-800' onClick={() => setTheme('dark')}>
